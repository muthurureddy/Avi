...
<?php
            ...
            <?php } ?>
            <div class="col-md-3 text-center"><button name="calender_price_update"id="he<?php echo$he; ?>" class="btn btn-success onclcick_submit_price " value="<?php echo $row9['calid']; ?>"><!--<i class="fa fa-pencil"></i>--><i class="fa fa-wrench" aria-hidden="true"></i></button>
    ...
    border-bottom: 2px solid rgb(252, 139, 17);">
          <div class="col-md-12 form-group">
            ...
            <a href="<?php echo $row9['calid']; ?>" class="btn-info btn">Update Details</a>
          </div></div>
          <?php
      }
      else{
