...
if($match1=mysqli_fetch_array($query1)){
	 ...
	 if(!empty($match['rules_doid'])) {
	  ...
	  <div class="row">
	<div class="col-md-12">
	<h4 class="color1  mg-top20">Safety Card</h4>
      <h5 class="color1 mg-top20">Fire Exitinguisher</h5>
	  <p><?php echo $match['fire_extinguisher'];?></p>
	  </div>
	  </div>
	  <div class="row">
	<div class="col-md-12">
      <h5 class="color1 mg-top20">Fire Exitinguisher</h5>
	  <p><?php echo $match['fire_alarm'];?></p>
	  </div>
	  </div>
	  <div class="row">
	<div class="col-md-12">
      <h5 class="color1 mg-top20">Fire Exitinguisher</h5>
	  <p><?php echo $match['gas_valve'];?></p>
	  </div>
	  </div>
	  <!---==========================Rules section Ends=======================-->
